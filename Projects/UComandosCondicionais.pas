...
begin
  ...
  if rgNivel.Items[rgNivel.ItemIndex] = 'Estagiário' then
    ShowMessage('Eu ' + name + ' sou do nivel >> Estágiario');
  ...
  if rgNivel.Items[rgNivel.ItemIndex] = 'sênior' then
    ShowMessage('Eu ' + name +' sou do nivel >> Sênior');
